...
static void MX_I2S6_Init(void)
{
  ...
  hi2s6.Init.AudioFreq = I2S_AUDIOFREQ_96K;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LCD_BL_DRIVE_GPIO_Port, LCD_BL_DRIVE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : B1_VOL_UP_Pin B1_VOL_DOWN_Pin B1_BACK_Pin */
  GPIO_InitStruct.Pin = B1_VOL_UP_Pin|B1_VOL_DOWN_Pin|B1_BACK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : B1_PLAY_Pin B1_MFB_Pin B1_FWD_Pin */
  GPIO_InitStruct.Pin = B1_PLAY_Pin|B1_MFB_Pin|B1_FWD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LCD_GPIO3_Pin LCD_GPIO2_Pin */
  GPIO_InitStruct.Pin = LCD_GPIO3_Pin|LCD_GPIO2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : LCD_INT_N_Pin I2C5_INT0_N_Pin */
  GPIO_InitStruct.Pin = LCD_INT_N_Pin|I2C5_INT0_N_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : LCD_PD_N_Pin */
  GPIO_InitStruct.Pin = LCD_PD_N_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LCD_PD_N_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : LCD_B1_D3_Pin */
  GPIO_InitStruct.Pin = LCD_B1_D3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(LCD_B1_D3_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : LCD_BL_DRIVE_Pin */
  GPIO_InitStruct.Pin = LCD_BL_DRIVE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LCD_BL_DRIVE_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : B1_LCD_SWITCH_Pin B1_LEDMODE_1_Pin B1_LEDMODE_2_Pin */
  GPIO_InitStruct.Pin = B1_LCD_SWITCH_Pin|B1_LEDMODE_1_Pin|B1_LEDMODE_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : CHG_ACOK_Pin */
  GPIO_InitStruct.Pin = CHG_ACOK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(CHG_ACOK_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : AMP_CLIP_OTW_N_Pin AMP_FAULT_N_Pin AMP_RESET_N_Pin */
  GPIO_InitStruct.Pin = AMP_CLIP_OTW_N_Pin|AMP_FAULT_N_Pin|AMP_RESET_N_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : I2C5_INT1_N_Pin I2C5_INT2_N_Pin I2C5_INT3_N_Pin I2C5_INT4_N_Pin */
  GPIO_InitStruct.Pin = I2C5_INT1_N_Pin|I2C5_INT2_N_Pin|I2C5_INT3_N_Pin|I2C5_INT4_N_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : I2C1_INT0_N_Pin */
  GPIO_InitStruct.Pin = I2C1_INT0_N_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
