...
#define IOT_CMD_NAME "NAME %012X\r"
#define IOT_CMD_OPEN "OPEN %012X %s\r"
#define IOT_CMD_OPEN_LONG "OPEN %012X %s %u %X %06X %u\r"
//#define IOT_CMD_PAIR "PAIR %012X\r"
//#define IOT_CMD_PAIR_LE "PAIR_LE %012X %u\r"
...
#define IOT_CMD_RSSI "RSSI %012X\r"
#define IOT_CMD_QUALITY "QUALITY %012X\r"
//#define IOT_CMD_SCAN "SCAN %u\r"
//#define IOT_CMD_SCAN_UNI "SCAN_UNI %s %u %u\r"
#define IOT_CMD_SEND "SEND %02X %s\r"
//#define IOT_CMD_SEND_RAW "SEND_RAW %02X %u\r"
//#define IOT_CMD_SET "SET %s\r"
...
#define IOT_NOTIF_ERROR "ERROR 0x%X\r"
//#define IOT_NOTIF_PENDING "PENDING\r"
#define IOT_NOTIF_READY "Ready\r"
#define IOT_NOTIF_NAME "NAME %llX \"%255[^\"]\"\r"
#define IOT_NOTIF_RSSI "RSSI=%d\r"
#define IOT_NOTIF_QUALITY "QUALITY=%u\r"
#define IOT_NOTIF_STATE "STATE CONNECTABLE[%255s] DISCOVERABLE[%255s] ADVERTISING[%255s] SCAN_UNI[%255s]\r"
#define IOT_NOTIF_LINK_A2DP "LINK %X A2DP %llX %255s %255s %255s %lu\r"
#define IOT_NOTIF_LINK_AVRCP "LINK %X AVRCP %llX %255s\r"
//#define IOT_NOTIF_LINK_HFP "LINK %X HFP %llX %255s %255s %255s\r"
//#define IOT_NOTIF_LINK_BLE "LINK %X BLE %llX %u\r"
#define IOT_NOTIF_LINK_BRX1 "LINK %X BRX1 %llX 0x%lX %255s %255s PDEL %lu RATE %lu ENCR: %u SUBGROUP %u\r"
#define IOT_NOTIF_LINK_BTX1 "LINK %X BTX1 %llX %255s PDEL %lu RATE %lu SUBGROUP %u BISS %u\r"
#define IOT_NOTIF_A2DP_STREAM_START "A2DP_STREAM_START %X\r"
#define IOT_NOTIF_A2DP_STREAM_SUSPEND "A2DP_STREAM_SUSPEND %X\r"
#define IOT_NOTIF_ABS_VOL "ABS_VOL %X %u\r"
//#define IOT_NOTIF_AT "AT %X %u %255s\r"
#define IOT_NOTIF_AVRCP_BACKWARD "AVRCP_BACKWARD %X\r"
#define IOT_NOTIF_AVRCP_FORWARD "AVRCP_FORWARD %X\r"
#define IOT_NOTIF_AVRCP_MEDIA_TITLE "AVRCP_MEDIA %X TITLE: %255[^\r]\r"
#define IOT_NOTIF_AVRCP_MEDIA_ARTIST "AVRCP_MEDIA %X ARTIST: %255[^\r]\r"
#define IOT_NOTIF_AVRCP_MEDIA_ALBUM "AVRCP_MEDIA %X ALBUM: %255[^\r]\r"
#define IOT_NOTIF_AVRCP_PAUSE "AVRCP_PAUSE %X\r"
#define IOT_NOTIF_AVRCP_PLAY "AVRCP_PLAY %X\r"
#define IOT_NOTIF_AVRCP_STOP "AVRCP_STOP %X\r"
...
#define IOT_NOTIF_CLOSE_OK "CLOSE_OK %X %255s\r"
#define IOT_NOTIF_LINK_LOSS "LINK_LOSS %X %255s\r"
#define IOT_NOTIF_OPEN_OK "OPEN_OK %X %255s %llX\r"
#define IOT_NOTIF_OPEN_ERROR "OPEN_ERROR %llX %255s %u\r"
...
#define IOT_NOTIF_RECV "RECV %X %u %255[^\r]\r"
