...
static int8_t AUDIO_Init_FS(uint32_t AudioFreq, int16_t Volume, uint8_t options);
static int8_t AUDIO_DeInit_FS(uint8_t options);
...
void HAL_I2S_ErrorCallback(I2S_HandleTypeDef *hi2s) {
  printf("i2s error: %lu", HAL_I2S_GetError(hi2s));
}
